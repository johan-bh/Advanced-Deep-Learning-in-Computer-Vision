...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        # Reshape using einops rearrange for cleaner transformation
        ...
        # Rearrange output from (batch_size x num_head) x seq_length x head_dim 
        # to batch_size x seq_length x embed_dim
...
class PositionalEncoding(nn.Module):
    def __init__(self, embed_dim, max_seq_len=512):
        ...
        # Get the positions for even indices (0, 2, 4, ...)
        div_term = torch.exp(
